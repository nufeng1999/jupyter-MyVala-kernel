...
class MyValaKernel(MyKernel):
    ...
    def _exec_valac_(self,source_filename,magics):
        ...
        with self.new_temp_file(suffix='.out') as binary_file:
            ...
            if p.returncode != 0:  # Compilation failed
                ...
                self._log("valac exited with code {}, the executable will not be executed".format(p.returncode),3)
    ...
    def do_runcode(self,return_code,fil_ename,magics,code, silent, store_history=True,
        ...
        if len(magics['dlrun'])>0:
            p = self.create_jupyter_subprocess([self.master_path, fil_ename] + magics['_st']['args'],env=self.addkey2dict(magics,'env'))
        else:
    ...
    def do_create_codefile(self,magics,code, silent, store_history=True,
        ...
        retinfo=self.get_retinfo()
        retstr=''
        source_file=self.create_codetemp_file(magics,code,suffix='.vala')
